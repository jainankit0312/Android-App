...
public class AssetsDAO extends SqlMapClientDaoSupport {
	...
	public List getAssetsOnIDMain(String id) {
		Map QueryData = new HashMap();
		QueryData.put("id", id);
		return super.getSqlMapClientTemplate().queryForList("getAssetsOnIDMain",
				QueryData);
	}
	public List getAssetsOnIDStandard(String id) {
		Map QueryData = new HashMap();
		QueryData.put("id", id);
		return super.getSqlMapClientTemplate().queryForList("getAssetsOnIDStandard",
				QueryData);
	}
	public List getAssetsOnIDSpecific(String id) {
		Map QueryData = new HashMap();
		QueryData.put("id", id);
		return super.getSqlMapClientTemplate().queryForList("getAssetsOnIDSpecific",
				QueryData);
	}
